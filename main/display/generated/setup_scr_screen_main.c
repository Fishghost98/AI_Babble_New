...
void setup_scr_screen_main(lv_ui *ui)
{
    ...
    ui->screen_main_img_index = lv_img_create(ui->screen_main);
    ...
    // // lv_img_set_pivot(ui->screen_main_img_index, 50,50);
    // // lv_img_set_angle(ui->screen_main_img_index, 0);

    // Write style for screen_main_img_index, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_img_recolor_opa(ui->screen_main_img_index, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_img_opa(ui->screen_main_img_index, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_main_img_index, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->screen_main_img_index, true, LV_PART_MAIN | LV_STATE_DEFAULT);
