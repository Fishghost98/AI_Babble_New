...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_image_src(ui->screen, &_bk1_RGB565A8_360x360, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_img_1, 130, 130);
    lv_obj_set_size(ui->screen_img_1, 100, 100);
    lv_obj_add_flag(ui->screen_img_1, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_img_1, &_chat1_RGB565A8_100x100);
