...
void setup_scr_screen_autoShutDown(lv_ui *ui)
{
    ...
    // Write codes screen_autoShutDown_label_6
    ui->screen_autoShutDown_label_6 = lv_label_create(ui->screen_autoShutDown);
    lv_label_set_text(ui->screen_autoShutDown_label_6, "(仅在便携模式下生效)");
    lv_label_set_long_mode(ui->screen_autoShutDown_label_6, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_autoShutDown_label_6, 102, 50);
    lv_obj_set_size(ui->screen_autoShutDown_label_6, 156, 13);

    // Write style for screen_autoShutDown_label_6, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->screen_autoShutDown_label_6, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_autoShutDown_label_6, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_autoShutDown_label_6, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_autoShutDown_label_6, &lv_font_ZiTiQuanWeiJunHeiW22_13, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->screen_autoShutDown_label_6, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->screen_autoShutDown_label_6, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->screen_autoShutDown_label_6, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->screen_autoShutDown_label_6, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_autoShutDown_label_6, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_autoShutDown_label_6, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_autoShutDown_label_6, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_autoShutDown_label_6, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_left(ui->screen_autoShutDown_label_6, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_autoShutDown_label_6, 0, LV_PART_MAIN | LV_STATE_DEFAULT);

    // Write codes screen_autoShutDown_label_1
    ui->screen_autoShutDown_label_1 = lv_label_create(ui->screen_autoShutDown);
    lv_label_set_text(ui->screen_autoShutDown_label_1, "自动关机");
    lv_label_set_long_mode(ui->screen_autoShutDown_label_1, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_autoShutDown_label_1, 130, 25);
    lv_obj_set_size(ui->screen_autoShutDown_label_1, 100, 20);
    ...
    lv_obj_set_style_text_font(ui->screen_autoShutDown_label_1, &lv_font_ZiTiQuanWeiJunHeiW22_20, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    switch (save_config.autoShutDownTime)
    {
    case 0:
        ui->screen_autoShutDown_list_1_item0 = lv_list_add_btn(ui->screen_autoShutDown_list_1, &_selected_green_alpha_20x20, "从不");
        ui->screen_autoShutDown_list_1_item1 = lv_list_add_btn(ui->screen_autoShutDown_list_1, &_black_alpha_20x20, "5分钟");
        ui->screen_autoShutDown_list_1_item2 = lv_list_add_btn(ui->screen_autoShutDown_list_1, &_black_alpha_20x20, "10分钟");
        ui->screen_autoShutDown_list_1_item3 = lv_list_add_btn(ui->screen_autoShutDown_list_1, &_black_alpha_20x20, "30分钟");
        ui->screen_autoShutDown_list_1_item4 = lv_list_add_btn(ui->screen_autoShutDown_list_1, &_black_alpha_20x20, "1小时");
        ui->screen_autoShutDown_list_1_item5 = lv_list_add_btn(ui->screen_autoShutDown_list_1, &_black_alpha_20x20, "6小时");
        break;
    case 5:
        ui->screen_autoShutDown_list_1_item0 = lv_list_add_btn(ui->screen_autoShutDown_list_1, &_black_alpha_20x20, "从不");
        ui->screen_autoShutDown_list_1_item1 = lv_list_add_btn(ui->screen_autoShutDown_list_1, &_selected_green_alpha_20x20, "5分钟");
        ui->screen_autoShutDown_list_1_item2 = lv_list_add_btn(ui->screen_autoShutDown_list_1, &_black_alpha_20x20, "10分钟");
        ui->screen_autoShutDown_list_1_item3 = lv_list_add_btn(ui->screen_autoShutDown_list_1, &_black_alpha_20x20, "30分钟");
        ui->screen_autoShutDown_list_1_item4 = lv_list_add_btn(ui->screen_autoShutDown_list_1, &_black_alpha_20x20, "1小时");
        ui->screen_autoShutDown_list_1_item5 = lv_list_add_btn(ui->screen_autoShutDown_list_1, &_black_alpha_20x20, "6小时");
    ...
    case 10:
        ui->screen_autoShutDown_list_1_item0 = lv_list_add_btn(ui->screen_autoShutDown_list_1, &_black_alpha_20x20, "从不");
        ui->screen_autoShutDown_list_1_item1 = lv_list_add_btn(ui->screen_autoShutDown_list_1, &_black_alpha_20x20, "5分钟");
        ui->screen_autoShutDown_list_1_item2 = lv_list_add_btn(ui->screen_autoShutDown_list_1, &_selected_green_alpha_20x20, "10分钟");
        ui->screen_autoShutDown_list_1_item3 = lv_list_add_btn(ui->screen_autoShutDown_list_1, &_black_alpha_20x20, "30分钟");
        ui->screen_autoShutDown_list_1_item4 = lv_list_add_btn(ui->screen_autoShutDown_list_1, &_black_alpha_20x20, "1小时");
        ui->screen_autoShutDown_list_1_item5 = lv_list_add_btn(ui->screen_autoShutDown_list_1, &_black_alpha_20x20, "6小时");
        break;
    case 30:
        ...
        ui->screen_autoShutDown_list_1_item1 = lv_list_add_btn(ui->screen_autoShutDown_list_1, &_black_alpha_20x20, "5分钟");
        ui->screen_autoShutDown_list_1_item2 = lv_list_add_btn(ui->screen_autoShutDown_list_1, &_black_alpha_20x20, "10分钟");
        ui->screen_autoShutDown_list_1_item3 = lv_list_add_btn(ui->screen_autoShutDown_list_1, &_selected_green_alpha_20x20, "30分钟");
        ui->screen_autoShutDown_list_1_item4 = lv_list_add_btn(ui->screen_autoShutDown_list_1, &_black_alpha_20x20, "1小时");
        ui->screen_autoShutDown_list_1_item5 = lv_list_add_btn(ui->screen_autoShutDown_list_1, &_black_alpha_20x20, "6小时");
        break;
    case 60:
        ...
        ui->screen_autoShutDown_list_1_item2 = lv_list_add_btn(ui->screen_autoShutDown_list_1, &_black_alpha_20x20, "10分钟");
        ui->screen_autoShutDown_list_1_item3 = lv_list_add_btn(ui->screen_autoShutDown_list_1, &_black_alpha_20x20, "30分钟");
        ui->screen_autoShutDown_list_1_item4 = lv_list_add_btn(ui->screen_autoShutDown_list_1, &_selected_green_alpha_20x20, "1小时");
        ui->screen_autoShutDown_list_1_item5 = lv_list_add_btn(ui->screen_autoShutDown_list_1, &_black_alpha_20x20, "6小时");
        break;
    case 360:
        ui->screen_autoShutDown_list_1_item0 = lv_list_add_btn(ui->screen_autoShutDown_list_1, &_black_alpha_20x20, "从不");
        ...
        ui->screen_autoShutDown_list_1_item3 = lv_list_add_btn(ui->screen_autoShutDown_list_1, &_black_alpha_20x20, "30分钟");
        ui->screen_autoShutDown_list_1_item4 = lv_list_add_btn(ui->screen_autoShutDown_list_1, &_black_alpha_20x20, "1小时");
        ui->screen_autoShutDown_list_1_item5 = lv_list_add_btn(ui->screen_autoShutDown_list_1, &_selected_green_alpha_20x20, "6小时");
        break;
    default:
        break;
    }
    ...
    lv_obj_set_scrollbar_mode(ui->screen_autoShutDown_list_1, LV_SCROLLBAR_MODE_AUTO);
    ...
    lv_style_set_pad_bottom(&style_screen_autoShutDown_list_1_extra_btns_main_default, 12);
    ...
    lv_style_set_pad_bottom(&style_screen_autoShutDown_list_1_extra_texts_main_default, 11);
    lv_style_set_border_width(&style_screen_autoShutDown_list_1_extra_texts_main_default, 0);
    lv_style_set_text_color(&style_screen_autoShutDown_list_1_extra_texts_main_default, lv_color_hex(0xffffff));
    lv_style_set_text_font(&style_screen_autoShutDown_list_1_extra_texts_main_default, &lv_font_ZiTiQuanWeiJunHeiW22_23);
    ...
    lv_style_set_bg_opa(&style_screen_autoShutDown_list_1_extra_texts_main_default, 0);
