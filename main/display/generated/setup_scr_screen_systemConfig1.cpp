...
void setup_scr_screen_systemConfig1(lv_ui *ui)
{
    ...
    ui->screen_systemConfig1_cont_3 = lv_obj_create(ui->screen_systemConfig1);
    lv_obj_set_pos(ui->screen_systemConfig1_cont_3, 2, 57);
    lv_obj_set_size(ui->screen_systemConfig1_cont_3, 356, 280);
    ...
    ui->screen_systemConfig1_cont_2 = lv_obj_create(ui->screen_systemConfig1_cont_3);
    ...
    ui->screen_systemConfig1_img_1 = lv_image_create(ui->screen_systemConfig1_cont_2);
    ...
    lv_image_set_src(ui->screen_systemConfig1_img_1, &_g1_RGB565A8_70x70);
    lv_image_set_pivot(ui->screen_systemConfig1_img_1, 50,50);
    lv_image_set_rotation(ui->screen_systemConfig1_img_1, 0);

    //Write style for screen_systemConfig1_img_1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_image_recolor_opa(ui->screen_systemConfig1_img_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_image_opa(ui->screen_systemConfig1_img_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_systemConfig1_img_2 = lv_image_create(ui->screen_systemConfig1_cont_2);
    ...
    lv_image_set_src(ui->screen_systemConfig1_img_2, &_right1_RGB565A8_25x25);
    lv_image_set_pivot(ui->screen_systemConfig1_img_2, 50,50);
    lv_image_set_rotation(ui->screen_systemConfig1_img_2, 0);

    //Write style for screen_systemConfig1_img_2, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_image_recolor_opa(ui->screen_systemConfig1_img_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_image_opa(ui->screen_systemConfig1_img_2, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_border_opa(ui->screen_systemConfig1_cont_1, 86, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_systemConfig1_cont_4, 20, 113);
    lv_obj_set_size(ui->screen_systemConfig1_cont_4, 320, 95);
    ...
    lv_obj_set_style_border_opa(ui->screen_systemConfig1_cont_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->screen_systemConfig1_cont_4, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->screen_systemConfig1_cont_4, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_systemConfig1_cont_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_systemConfig1_img_4 = lv_image_create(ui->screen_systemConfig1_cont_4);
    ...
    lv_image_set_src(ui->screen_systemConfig1_img_4, &_g2_RGB565A8_70x70);
    lv_image_set_pivot(ui->screen_systemConfig1_img_4, 50,50);
    lv_image_set_rotation(ui->screen_systemConfig1_img_4, 0);

    //Write style for screen_systemConfig1_img_4, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_image_recolor_opa(ui->screen_systemConfig1_img_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_image_opa(ui->screen_systemConfig1_img_4, 255, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_systemConfig1_label_4
    ui->screen_systemConfig1_label_4 = lv_label_create(ui->screen_systemConfig1_cont_4);
    lv_obj_set_pos(ui->screen_systemConfig1_label_4, 110, 30);
    lv_obj_set_size(ui->screen_systemConfig1_label_4, 120, 28);
    lv_label_set_text(ui->screen_systemConfig1_label_4, "使用说明");
    ...
    ui->screen_systemConfig1_img_3 = lv_image_create(ui->screen_systemConfig1_cont_4);
    ...
    lv_image_set_src(ui->screen_systemConfig1_img_3, &_right1_RGB565A8_25x25);
    lv_image_set_pivot(ui->screen_systemConfig1_img_3, 50,50);
    lv_image_set_rotation(ui->screen_systemConfig1_img_3, 0);

    //Write style for screen_systemConfig1_img_3, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_image_recolor_opa(ui->screen_systemConfig1_img_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_image_opa(ui->screen_systemConfig1_img_3, 255, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_systemConfig1_cont_5
    ui->screen_systemConfig1_cont_5 = lv_obj_create(ui->screen_systemConfig1_cont_4);
    lv_obj_set_pos(ui->screen_systemConfig1_cont_5, 0, 2);
    lv_obj_set_size(ui->screen_systemConfig1_cont_5, 310, 85);
    ...
    lv_obj_set_style_border_opa(ui->screen_systemConfig1_cont_5, 86, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->screen_systemConfig1_cont_5, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->screen_systemConfig1_cont_5, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_systemConfig1_cont_5, 40, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_systemConfig1_cont_6 = lv_obj_create(ui->screen_systemConfig1_cont_3);
    lv_obj_set_pos(ui->screen_systemConfig1_cont_6, 20, 216);
    lv_obj_set_size(ui->screen_systemConfig1_cont_6, 320, 95);
    ...
    lv_obj_set_style_border_opa(ui->screen_systemConfig1_cont_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->screen_systemConfig1_cont_6, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->screen_systemConfig1_cont_6, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_systemConfig1_cont_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_systemConfig1_img_6 = lv_image_create(ui->screen_systemConfig1_cont_6);
    ...
    lv_image_set_src(ui->screen_systemConfig1_img_6, &_reset1_RGB565A8_70x70);
    lv_image_set_pivot(ui->screen_systemConfig1_img_6, 50,50);
    lv_image_set_rotation(ui->screen_systemConfig1_img_6, 0);

    //Write style for screen_systemConfig1_img_6, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_image_recolor_opa(ui->screen_systemConfig1_img_6, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_image_opa(ui->screen_systemConfig1_img_6, 255, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_systemConfig1_label_5
    ui->screen_systemConfig1_label_5 = lv_label_create(ui->screen_systemConfig1_cont_6);
    lv_obj_set_pos(ui->screen_systemConfig1_label_5, 110, 30);
    lv_obj_set_size(ui->screen_systemConfig1_label_5, 120, 28);
    lv_label_set_text(ui->screen_systemConfig1_label_5, "出厂设置");
    ...
    ui->screen_systemConfig1_img_5 = lv_image_create(ui->screen_systemConfig1_cont_6);
    ...
    lv_image_set_src(ui->screen_systemConfig1_img_5, &_right1_RGB565A8_25x25);
    lv_image_set_pivot(ui->screen_systemConfig1_img_5, 50,50);
    lv_image_set_rotation(ui->screen_systemConfig1_img_5, 0);

    //Write style for screen_systemConfig1_img_5, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_image_recolor_opa(ui->screen_systemConfig1_img_5, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_image_opa(ui->screen_systemConfig1_img_5, 255, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_systemConfig1_cont_7
    ui->screen_systemConfig1_cont_7 = lv_obj_create(ui->screen_systemConfig1_cont_6);
    lv_obj_set_pos(ui->screen_systemConfig1_cont_7, 0, 2);
    lv_obj_set_size(ui->screen_systemConfig1_cont_7, 310, 85);
    ...
    lv_obj_set_style_border_opa(ui->screen_systemConfig1_cont_7, 86, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->screen_systemConfig1_cont_7, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->screen_systemConfig1_cont_7, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_systemConfig1_cont_7, 40, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_systemConfig1_cont_8 = lv_obj_create(ui->screen_systemConfig1_cont_3);
    lv_obj_set_pos(ui->screen_systemConfig1_cont_8, 20, 319);
    lv_obj_set_size(ui->screen_systemConfig1_cont_8, 320, 95);
    ...
    lv_obj_set_style_border_opa(ui->screen_systemConfig1_cont_8, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->screen_systemConfig1_cont_8, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->screen_systemConfig1_cont_8, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_systemConfig1_cont_8, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_systemConfig1_img_8 = lv_image_create(ui->screen_systemConfig1_cont_8);
    ...
    lv_image_set_src(ui->screen_systemConfig1_img_8, &_g3_RGB565A8_70x70);
    lv_image_set_pivot(ui->screen_systemConfig1_img_8, 50,50);
    lv_image_set_rotation(ui->screen_systemConfig1_img_8, 0);

    //Write style for screen_systemConfig1_img_8, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_image_recolor_opa(ui->screen_systemConfig1_img_8, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_image_opa(ui->screen_systemConfig1_img_8, 255, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_systemConfig1_label_6
    ui->screen_systemConfig1_label_6 = lv_label_create(ui->screen_systemConfig1_cont_8);
    ...
    ui->screen_systemConfig1_img_7 = lv_image_create(ui->screen_systemConfig1_cont_8);
    ...
    lv_image_set_src(ui->screen_systemConfig1_img_7, &_right1_RGB565A8_25x25);
    lv_image_set_pivot(ui->screen_systemConfig1_img_7, 50,50);
    lv_image_set_rotation(ui->screen_systemConfig1_img_7, 0);

    //Write style for screen_systemConfig1_img_7, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_image_recolor_opa(ui->screen_systemConfig1_img_7, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_image_opa(ui->screen_systemConfig1_img_7, 255, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_systemConfig1_cont_9
    ui->screen_systemConfig1_cont_9 = lv_obj_create(ui->screen_systemConfig1_cont_8);
    lv_obj_set_pos(ui->screen_systemConfig1_cont_9, 0, 2);
    lv_obj_set_size(ui->screen_systemConfig1_cont_9, 310, 85);
    ...
    lv_obj_set_style_border_opa(ui->screen_systemConfig1_cont_9, 86, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->screen_systemConfig1_cont_9, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->screen_systemConfig1_cont_9, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_systemConfig1_cont_9, 40, LV_PART_MAIN|LV_STATE_DEFAULT);
