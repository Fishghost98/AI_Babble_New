...
void setup_scr_screen_picture_display(lv_ui *ui)
{
    ...
    ui->screen_picture_display_img_display = lv_img_create(ui->screen_picture_display);
    ...
    // lv_img_set_src(ui->screen_picture_display_img_display, all_config.pics_picture[all_config.page_pic_display.pic_index]);
    // lv_img_set_pivot(ui->screen_picture_display_img_display, 50,50);
    // lv_img_set_angle(ui->screen_picture_display_img_display, 0);
    ...
    lv_obj_set_style_img_recolor_opa(ui->screen_picture_display_img_display, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_img_opa(ui->screen_picture_display_img_display, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_picture_display_img_display, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->screen_picture_display_img_display, true, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_move_foreground(ui->screen_picture_display_list_1);
    ...
    lv_style_set_text_color(&style_screen_picture_display_list_1_extra_btns_main_default, lv_color_hex(0x000000));
    lv_style_set_text_font(&style_screen_picture_display_list_1_extra_btns_main_default, &lv_font_ZiTiQuanWeiJunHeiW22_19);
    ...
    lv_style_set_bg_opa(&style_screen_picture_display_list_1_extra_btns_main_default, 0);
