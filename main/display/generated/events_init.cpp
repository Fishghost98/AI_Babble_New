...
static void screen_mainConfig_event_handler (lv_event_t *e)
{
    ...
    {
        ui_load_scr_animation(&guider_ui, &guider_ui.screen_picture, guider_ui.screen_picture_del, &guider_ui.screen_mainConfig_del, setup_scr_screen_picture, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
        break;
    }
    case LV_EVENT_GESTURE:
    {
        ...
        case LV_DIR_LEFT:
        {
            ...
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_chat, guider_ui.screen_chat_del, &guider_ui.screen_mainConfig_del, setup_scr_screen_chat, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
            break;
        }
        case LV_DIR_RIGHT:
        {
...
static void screen_chat_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ui_load_scr_animation(&guider_ui, &guider_ui.screen_chatDetail, guider_ui.screen_chatDetail_del, &guider_ui.screen_chat_del, setup_scr_screen_chatDetail, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
        break;
    }
    case LV_EVENT_GESTURE:
    {
        ...
        {
            lv_indev_wait_release(lv_indev_active());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_remind, guider_ui.screen_remind_del, &guider_ui.screen_chat_del, setup_scr_screen_remind, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
            break;
        }
        case LV_DIR_RIGHT:
        {
            lv_indev_wait_release(lv_indev_active());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_mainConfig, guider_ui.screen_mainConfig_del, &guider_ui.screen_chat_del, setup_scr_screen_mainConfig, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
            break;
        }
        default:
            break;
...
static void screen_remind_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ui_load_scr_animation(&guider_ui, &guider_ui.screen_remindDetail, guider_ui.screen_remindDetail_del, &guider_ui.screen_remind_del, setup_scr_screen_remindDetail, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
        break;
    }
    case LV_EVENT_GESTURE:
    {
        ...
        {
            lv_indev_wait_release(lv_indev_active());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_meeting, guider_ui.screen_meeting_del, &guider_ui.screen_remind_del, setup_scr_screen_meeting, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
            break;
        }
        case LV_DIR_RIGHT:
        {
            lv_indev_wait_release(lv_indev_active());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_chat, guider_ui.screen_chat_del, &guider_ui.screen_remind_del, setup_scr_screen_chat, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
            break;
        }
        default:
            break;
...
static void screen_meeting_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ui_load_scr_animation(&guider_ui, &guider_ui.screen_meetingDetail, guider_ui.screen_meetingDetail_del, &guider_ui.screen_meeting_del, setup_scr_screen_meetingDetail, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
        break;
    }
    case LV_EVENT_GESTURE:
    {
        ...
        {
            lv_indev_wait_release(lv_indev_active());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_systemConfig, guider_ui.screen_systemConfig_del, &guider_ui.screen_meeting_del, setup_scr_screen_systemConfig, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
            break;
        }
        case LV_DIR_RIGHT:
        {
            lv_indev_wait_release(lv_indev_active());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_remind, guider_ui.screen_remind_del, &guider_ui.screen_meeting_del, setup_scr_screen_remind, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
            break;
        }
        default:
            break;
...
static void screen_systemConfig_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ui_load_scr_animation(&guider_ui, &guider_ui.screen_systemConfig1, guider_ui.screen_systemConfig1_del, &guider_ui.screen_systemConfig_del, setup_scr_screen_systemConfig1, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
        break;
    }
    case LV_EVENT_GESTURE:
    {
        ...
        {
            lv_indev_wait_release(lv_indev_active());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_mainConfig, guider_ui.screen_mainConfig_del, &guider_ui.screen_systemConfig_del, setup_scr_screen_mainConfig, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
            break;
        }
        case LV_DIR_RIGHT:
        {
            lv_indev_wait_release(lv_indev_active());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_remind, guider_ui.screen_remind_del, &guider_ui.screen_systemConfig_del, setup_scr_screen_remind, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
            break;
        }
        default:
            break;
...
static void screen_quick_config_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_GESTURE:
    {
        ...
        {
            lv_indev_wait_release(lv_indev_active());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_main, guider_ui.screen_main_del, &guider_ui.screen_quick_config_del, setup_scr_screen_main, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
            break;
        }
        default:
            break;
...
static void screen_quick_config_btn_power_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ui_load_scr_animation(&guider_ui, &guider_ui.screen_shutDown, guider_ui.screen_shutDown_del, &guider_ui.screen_quick_config_del, setup_scr_screen_shutDown, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
        break;
    }
    default:
        break;
...
static void screen_shutDown_btn_1_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ui_load_scr_animation(&guider_ui, &guider_ui.screen_quick_config, guider_ui.screen_quick_config_del, &guider_ui.screen_shutDown_del, setup_scr_screen_quick_config, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
        break;
    }
    default:
        break;
...
static void screen_picture_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ui_load_scr_animation(&guider_ui, &guider_ui.screen_picture_display, guider_ui.screen_picture_display_del, &guider_ui.screen_picture_del, setup_scr_screen_picture_display, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
        break;
    }
    case LV_EVENT_GESTURE:
    {
        ...
        {
            lv_indev_wait_release(lv_indev_active());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_gif, guider_ui.screen_gif_del, &guider_ui.screen_picture_del, setup_scr_screen_gif, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
            break;
        }
        case LV_DIR_RIGHT:
        {
            lv_indev_wait_release(lv_indev_active());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_mainConfig, guider_ui.screen_mainConfig_del, &guider_ui.screen_picture_del, setup_scr_screen_mainConfig, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
            break;
        }
        default:
            break;
...
static void screen_picture_display_img_display_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ui_load_scr_animation(&guider_ui, &guider_ui.screen_main, guider_ui.screen_main_del, &guider_ui.screen_picture_display_del, setup_scr_screen_main, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
        break;
    }
    default:
        break;
...
static void screen_gif_display_img_display_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ui_load_scr_animation(&guider_ui, &guider_ui.screen_main_gif, guider_ui.screen_main_gif_del, &guider_ui.screen_gif_display_del, setup_scr_screen_main_gif, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
        break;
    }
    default:
        break;
...
static void screen_gif_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ui_load_scr_animation(&guider_ui, &guider_ui.screen_gif_display, guider_ui.screen_gif_display_del, &guider_ui.screen_gif_del, setup_scr_screen_gif_display, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
        break;
    }
    case LV_EVENT_GESTURE:
    {
        ...
        {
            lv_indev_wait_release(lv_indev_active());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_clock, guider_ui.screen_clock_del, &guider_ui.screen_gif_del, setup_scr_screen_clock, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
            break;
        }
        case LV_DIR_RIGHT:
        {
            lv_indev_wait_release(lv_indev_active());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_picture, guider_ui.screen_picture_del, &guider_ui.screen_gif_del, setup_scr_screen_picture, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
            break;
        }
        default:
            break;
...
static void screen_clock_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_GESTURE:
    {
        ...
        {
            lv_indev_wait_release(lv_indev_active());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_gif, guider_ui.screen_gif_del, &guider_ui.screen_clock_del, setup_scr_screen_gif, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
            break;
        }
        default:
            break;
...
static void screen_clock_img_1_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_CLICKED:
    {
        ui_load_scr_animation(&guider_ui, &guider_ui.screen_home, guider_ui.screen_home_del, &guider_ui.screen_clock_del, setup_scr_screen_home, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
        break;
    }
    default:
        break;
...
static void screen_device_information_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_GESTURE:
    {
        ...
        {
            lv_indev_wait_release(lv_indev_active());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_systemConfig1, guider_ui.screen_systemConfig1_del, &guider_ui.screen_device_information_del, setup_scr_screen_systemConfig1, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
            break;
        }
        default:
            break;
...
{
    lv_obj_add_event_cb(ui->screen_device_information, screen_device_information_event_handler, LV_EVENT_ALL, ui);
}
...
static void screen_home_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_GESTURE:
    {
        ...
        {
            lv_indev_wait_release(lv_indev_active());
            ui_load_scr_animation(&guider_ui, &guider_ui.home_analog, guider_ui.home_analog_del, &guider_ui.screen_home_del, setup_scr_home_analog, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
            break;
        }
        case LV_DIR_RIGHT:
        {
            lv_indev_wait_release(lv_indev_active());
            ui_load_scr_animation(&guider_ui, &guider_ui.home_digital, guider_ui.home_digital_del, &guider_ui.screen_home_del, setup_scr_home_digital, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
            break;
        }
        case LV_DIR_BOTTOM:
        {
            lv_indev_wait_release(lv_indev_active());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_quick_config, guider_ui.screen_quick_config_del, &guider_ui.screen_home_del, setup_scr_screen_quick_config, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
            break;
        }
        case LV_DIR_TOP:
        {
            lv_indev_wait_release(lv_indev_active());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_mainConfig, guider_ui.screen_mainConfig_del, &guider_ui.screen_home_del, setup_scr_screen_mainConfig, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
            break;
        }
        default:
            break;
...
static void home_analog_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_GESTURE:
    {
        ...
        {
            lv_indev_wait_release(lv_indev_active());
            ui_load_scr_animation(&guider_ui, &guider_ui.home_digital, guider_ui.home_digital_del, &guider_ui.home_analog_del, setup_scr_home_digital, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
            break;
        }
        case LV_DIR_RIGHT:
        {
            lv_indev_wait_release(lv_indev_active());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_home, guider_ui.screen_home_del, &guider_ui.home_analog_del, setup_scr_screen_home, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
            break;
        }
        case LV_DIR_TOP:
        {
            lv_indev_wait_release(lv_indev_active());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_mainConfig, guider_ui.screen_mainConfig_del, &guider_ui.home_analog_del, setup_scr_screen_mainConfig, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
            break;
        }
        case LV_DIR_BOTTOM:
        {
            lv_indev_wait_release(lv_indev_active());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_quick_config, guider_ui.screen_quick_config_del, &guider_ui.home_analog_del, setup_scr_screen_quick_config, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
            break;
        }
        default:
            break;
...
static void home_digital_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_GESTURE:
    {
        ...
        {
            lv_indev_wait_release(lv_indev_active());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_home, guider_ui.screen_home_del, &guider_ui.home_digital_del, setup_scr_screen_home, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
            break;
        }
        case LV_DIR_RIGHT:
        {
            lv_indev_wait_release(lv_indev_active());
            ui_load_scr_animation(&guider_ui, &guider_ui.home_analog, guider_ui.home_analog_del, &guider_ui.home_digital_del, setup_scr_home_analog, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
            break;
        }
        default:
            break;
...
static void screen_main_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_GESTURE:
    {
        ...
        {
            lv_indev_wait_release(lv_indev_active());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_quick_config, guider_ui.screen_quick_config_del, &guider_ui.screen_main_del, setup_scr_screen_quick_config, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
            break;
        }
        default:
            break;
...
static void screen_main_gif_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_GESTURE:
    {
        ...
        {
            lv_indev_wait_release(lv_indev_active());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_mainConfig, guider_ui.screen_mainConfig_del, &guider_ui.screen_main_gif_del, setup_scr_screen_mainConfig, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
            break;
        }
        case LV_DIR_BOTTOM:
        {
            lv_indev_wait_release(lv_indev_active());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_quick_config, guider_ui.screen_quick_config_del, &guider_ui.screen_main_gif_del, setup_scr_screen_quick_config, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
            break;
        }
        default:
            break;
...
static void screen_chatDetail_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_GESTURE:
    {
        ...
        {
            lv_indev_wait_release(lv_indev_active());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_chat, guider_ui.screen_chat_del, &guider_ui.screen_chatDetail_del, setup_scr_screen_chat, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
            break;
        }
        default:
            break;
...
static void screen_remindDetail_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_GESTURE:
    {
        ...
        {
            lv_indev_wait_release(lv_indev_active());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_remind, guider_ui.screen_remind_del, &guider_ui.screen_remindDetail_del, setup_scr_screen_remind, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
            break;
        }
        default:
            break;
...
static void screen_meetingDetail_event_handler (lv_event_t *e)
{
    ...
    case LV_EVENT_GESTURE:
    {
        ...
        {
            lv_indev_wait_release(lv_indev_active());
            ui_load_scr_animation(&guider_ui, &guider_ui.screen_meeting, guider_ui.screen_meeting_del, &guider_ui.screen_meetingDetail_del, setup_scr_screen_meeting, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
            break;
        }
        default:
            break;
...
void events_init_screen_meetingDetail (lv_ui *ui)
{
    ...
    lv_obj_add_event_cb(ui->screen_meetingDetail_btn_1, screen_meetingDetail_btn_1_event_handler, LV_EVENT_ALL, ui);
}
