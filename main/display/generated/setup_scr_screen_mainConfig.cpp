...
{
    //Write codes screen_mainConfig
    ui->screen_mainConfig = lv_obj_create(NULL);
    lv_obj_set_size(ui->screen_mainConfig, 360, 360);
    lv_obj_set_scrollbar_mode(ui->screen_mainConfig, LV_SCROLLBAR_MODE_OFF);

    //Write style for screen_mainConfig, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    ...
    lv_obj_set_style_radius(ui->screen_mainConfig_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_mainConfig_label_1, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_mainConfig_label_1, &lv_font_ZiTiQuanWeiJunHeiW22_30, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui->screen_mainConfig_label_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui->screen_mainConfig_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui->screen_mainConfig_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui->screen_mainConfig_label_1, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_mainConfig_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_mainConfig_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui->screen_mainConfig_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui->screen_mainConfig_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_update_layout(ui->screen_mainConfig);

    //Init events for screen.
    events_init_screen_mainConfig(ui);
}
