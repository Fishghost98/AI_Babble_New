...
void setup_scr_screen_reset(lv_ui *ui)
{
    ...
    ui->screen_reset_btn_1 = lv_btn_create(ui->screen_reset);
    ...
    lv_obj_set_style_radius(ui->screen_reset_btn_1, 70, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_shadow_width(ui->screen_reset_btn_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_img_src(ui->screen_reset_btn_1, &_cancel_60x60, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_img_opa(ui->screen_reset_btn_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_img_recolor_opa(ui->screen_reset_btn_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_reset_label_1, 130, 147);
    ...
    lv_obj_set_pos(ui->screen_reset_slider_1, 55, 130);
    ...
    lv_obj_set_style_bg_opa(ui->screen_reset_slider_1, 48, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui->screen_reset_slider_1, lv_color_hex(0xb0b0b0), LV_PART_INDICATOR|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_img_src(ui->screen_reset_slider_1, &_reset1_70x70, LV_PART_KNOB|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_img_opa(ui->screen_reset_slider_1, 255, LV_PART_KNOB|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_img_recolor_opa(ui->screen_reset_slider_1, 0, LV_PART_KNOB|LV_STATE_DEFAULT);
