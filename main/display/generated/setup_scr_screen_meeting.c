...
void setup_scr_screen_meeting(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_img_src(ui->screen_meeting, &_bk2_360x360, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_img_opa(ui->screen_meeting, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_img_recolor_opa(ui->screen_meeting, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    ui->screen_meeting_img_1 = lv_img_create(ui->screen_meeting);
    lv_obj_add_flag(ui->screen_meeting_img_1, LV_OBJ_FLAG_CLICKABLE);
    lv_img_set_src(ui->screen_meeting_img_1, &_meeting1_alpha_150x150);
    lv_img_set_pivot(ui->screen_meeting_img_1, 50,50);
    lv_img_set_angle(ui->screen_meeting_img_1, 0);
    ...
    lv_obj_set_style_img_recolor_opa(ui->screen_meeting_img_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_img_opa(ui->screen_meeting_img_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_meeting_img_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->screen_meeting_img_1, true, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_meeting_img_2
    ui->screen_meeting_img_2 = lv_img_create(ui->screen_meeting);
    lv_obj_add_flag(ui->screen_meeting_img_2, LV_OBJ_FLAG_CLICKABLE);
    lv_img_set_src(ui->screen_meeting_img_2, &_left1_alpha_75x290);
    lv_img_set_pivot(ui->screen_meeting_img_2, 50,50);
    lv_img_set_angle(ui->screen_meeting_img_2, 0);
    lv_obj_set_pos(ui->screen_meeting_img_2, 0, 35);
    ...
    lv_obj_set_style_img_recolor_opa(ui->screen_meeting_img_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_img_opa(ui->screen_meeting_img_2, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_meeting_img_2, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->screen_meeting_img_2, true, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_meeting_img_3
    ui->screen_meeting_img_3 = lv_img_create(ui->screen_meeting);
    lv_obj_add_flag(ui->screen_meeting_img_3, LV_OBJ_FLAG_CLICKABLE);
    lv_img_set_src(ui->screen_meeting_img_3, &_right2_alpha_75x290);
    lv_img_set_pivot(ui->screen_meeting_img_3, 50,50);
    lv_img_set_angle(ui->screen_meeting_img_3, 0);
    lv_obj_set_pos(ui->screen_meeting_img_3, 285, 35);
    ...
    lv_obj_set_style_img_recolor_opa(ui->screen_meeting_img_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_img_opa(ui->screen_meeting_img_3, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_meeting_img_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->screen_meeting_img_3, true, LV_PART_MAIN|LV_STATE_DEFAULT);

    //Write codes screen_meeting_img_4
    ui->screen_meeting_img_4 = lv_img_create(ui->screen_meeting);
    lv_obj_add_flag(ui->screen_meeting_img_4, LV_OBJ_FLAG_CLICKABLE);
    lv_img_set_src(ui->screen_meeting_img_4, &_dot4_alpha_50x6);
    lv_img_set_pivot(ui->screen_meeting_img_4, 50,50);
    lv_img_set_angle(ui->screen_meeting_img_4, 0);
    ...
    lv_obj_set_style_img_recolor_opa(ui->screen_meeting_img_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_img_opa(ui->screen_meeting_img_4, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_meeting_img_4, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_clip_corner(ui->screen_meeting_img_4, true, LV_PART_MAIN|LV_STATE_DEFAULT);
